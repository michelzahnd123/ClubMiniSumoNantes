...
bool Joystick::getJoystickBouton(){                     // booleen On - Off
    etatBouton=digitalRead(this->pin_joystickBouton);
    return etatBouton;
}
